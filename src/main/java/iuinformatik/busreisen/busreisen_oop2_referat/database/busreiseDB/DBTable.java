...
public class DBTable {
    ...
    public static int InitializeBus(Connection conn, String kennzeichen) throws SQLException {
        int id = DB.insertString(conn, Table.BUSSE, Table.Busse.Kennzeichen, kennzeichen);
        DB.updateDouble(conn, Table.BUSSE, Table.Busse.GefahreneKilo, 10.0 ,id);
        return id;
    }
}
